...
//
public class CopiedTest {

    @Test
    public void test() throws ConfigurationException, IOException, GenerationException {
        // Jmeter location
        ...
        if (!jmeterProperties.exists()) {
            ...
            csvDataSet.setProperty("filename", jmeterHome.getPath() + File.separator + "data.csv");
            ...
            SaveService.saveTree(testPlanTree, new FileOutputStream(jmeterHome + File.separator + "example.jmx"));
            ...
            System.out.println("JMeter .jmx script is available at " + jmeterHome + File.separator + "example.jmx");
